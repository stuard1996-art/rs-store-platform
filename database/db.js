...
function initSchema() {
  ...
  const defaults = [
    ...
    ['provincia_matriz', 'Guayas', 'Provincia matriz donde opera la tienda principal'],
    ['ciudad_matriz', 'Guayaquil', 'Ciudad matriz de la tienda principal'],
    ['ciudades_zona_local', 'Guayaquil, Samborondón, Durán, Daule', 'Ciudades con tarifa de Servientrega local'],
